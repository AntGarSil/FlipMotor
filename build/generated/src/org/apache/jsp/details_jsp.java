...
public final class details_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 if(null == session.getAttribute("userid") && null == session.getAttribute("adminid")){ 
      ...
      out.write("<!--<script src=\"js/jquery.validate.password.js\" type=\"text/javascript\"></script> --><script type=\"text/javascript\">\n");
      out.write("\n");
      out.write("function register_Validator(theForm)\n");
      out.write("{\n");
      out.write("\t\n");
      out.write("   \t\tvar nowDate = new Date();\t\t\n");
      out.write("  \t\tvar nowYear = nowDate.getFullYear();\t \n");
      out.write("   \t\tvar nowMonth = nowDate.getMonth() + 1;\n");
      out.write("   \t\tvar expYear = theForm.cboExpYear.options[theForm.cboExpYear.selectedIndex].value;\n");
      out.write("  \t\tvar expMonth = theForm.cboExpMonth.options[theForm.cboExpMonth.selectedIndex].value;\n");
      out.write("\t\t\n");
      out.write("\t\tif ((nowYear >= expYear)&&(nowMonth > expMonth))\n");
      out.write("\t\t{\n");
      out.write("  \t\t alert(\"expire date can't be in the past!\");\n");
      ...
      out.write("\t\t<ul>\n");
      out.write("\t\t\t<li><a href=\"#payment\">Payment</a></li>\n");
      out.write("\t\t</ul>\n");
      out.write("\t\t<div id=\"payment\" style=\"-webkit-border-radius: 10px; -moz-border-radius: 10px; border-radius: 10px; padding: 20px; height:480px; margin-bottom: 20px;\">\n");
      out.write("                    <form id=\"clientSignUp\" method=\"POST\" action=\"PaymentAction\" onsubmit=\"return register_Validator(this)\">\n");
      out.write("                        <div id=\"leftPanel\" style=\"float: left; width: 50%;\">\n");
      out.write("                            <p>\n");
      out.write("\t\t\t\t<label for=\"card\">Credit Card</label>\n");
      out.write("\t\t\t\t<input id=\"card\" name=\"card\" class=\"required\" minlength=\"16\" maxlength=\"16\" type=\"number\" />\n");
      out.write("                            </p><p>Expiry Date<br />\n");
      out.write("                                 Month:<SELECT NAME=\"cboExpMonth\" SIZE\t=\"1\">\n");
      out.write("\n");
      out.write("                                        <option VALUE=\"00\" selected></option>\n");
      ...
      out.write("                                         </SELECT>\n");
      out.write("\n");
      out.write("                                Year:    <SELECT NAME=\"cboExpYear\" SIZE=\"1\">\t\t\n");
      out.write("\n");
      out.write("                                                <option VALUE=\"00\" selected></option>\n");
      out.write("                                                        <OPTION VALUE=\"2004\">04</OPTION>\n");
      out.write("                                                        <OPTION VALUE=\"2005\">05</OPTION>\n");
      out.write("                                                <OPTION VALUE=\"2006\">06</OPTION>\n");
      out.write("                                                <OPTION VALUE=\"2007\">07</OPTION>\n");
      out.write("                                                <OPTION VALUE=\"2008\">06</OPTION>\n");
      out.write("                                                <OPTION VALUE=\"2009\">09</OPTION>\n");
      out.write("                                                <OPTION VALUE=\"2010\">10</OPTION>\n");
      out.write("                                                <OPTION VALUE=\"2011\">11</OPTION>\n");
      out.write("                                                <OPTION VALUE=\"2012\">12</OPTION>\n");
      out.write("                                         </SELECT>\n");
      out.write("                        </div>\n");
      out.write("                        \n");
      out.write("                        <div id=\"submitPanel\" style=\"float: left; width: 100%; margin-top: 5px;\">\n");
      out.write("                            <input type=\"submit\" value=\"Pay\" style=\"margin-left: auto; margin-right: auto; display:block;\" />\n");
      out.write("                        </div>\n");
      out.write("                        \n");
      out.write("                    </form>\n");
      out.write("\t\t</div>\n");
