...
public final class RegisterError_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 if(null == session.getAttribute("userid") && null == session.getAttribute("adminid")){ 
      ...
      out.write("    <div id=\"contactContainer\" style=\"width:390px; height: 80px;  margin: auto; border: 2px solid grey; padding: 40px; margin-top: 100px;\n");
      out.write("         -moz-border-radius: 5px; -webkit-border-radius: 5px; -khtml-border-radius: 5px;\" class=\"ui-state-error\">\n");
      out.write("        <div style=\"margin-top:20px;\">\n");
      out.write("            <span class=\"ui-icon ui-icon-alert\" style=\"float: left; \"></span>\n");
      out.write("            <span style=\"float: left; margin-left: 10px;\">\n");
      out.write("                <span style=\"font-weight: bold; font-size: 20px;\">Registration</span>\n");
      out.write("                <br> That email has already been registered\n");
      out.write("            </span>\n");
      out.write("        </div>\n");
      out.write("    </div>\n");
      out.write("\n");
