 ...
 * 
 */
@WebServiceClient(name = "BankService", targetNamespace = "http://BankService/", wsdlLocation = "file:/home/tiw/Escritorio/Project/build/generated-sources/jax-ws/resources/BankService.wsdl")
    ...
    extends Service
{
    ...
    private final static QName BANKSERVICE_QNAME = new QName("http://BankService/", "BankService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("file:/home/tiw/Escritorio/Project/build/generated-sources/jax-ws/resources/BankService.wsdl");
    ...
    public BankService getBankServicePort() {
        return super.getPort(new QName("http://BankService/", "BankServicePort"), BankService.class);
    }
    ...
    public BankService getBankServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://BankService/", "BankServicePort"), BankService.class, features);
    }
