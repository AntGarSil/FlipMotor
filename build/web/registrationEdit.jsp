...
<div id="bodyContent">
    ...
    -moz-border-radius: 5px; -webkit-border-radius: 5px; -khtml-border-radius: 5px;" >
		...
		<div id="client" style="-webkit-border-radius: 10px; -moz-border-radius: 10px; border-radius: 10px; padding: 20px; height:480px; margin-bottom: 20px;">
                    <form id="clientSignUp" method="post" action="/UserProfileController">
				...
				<h4>Address</h4>
                        ...
                        <div id="submitPanel" style="float: left; width: 100%; margin-top: 5px;">
                            <input type="submit" value="Edit" onclick="window.location='/src/java/controller/UserProfileController.java';" style="margin-left: auto; margin-right: auto; display:block;">
                        </div>
