...
<script src="js/jquery-ui.min.js" type="text/javascript"></script>-->
    ...
    -moz-border-radius: 5px; -webkit-border-radius: 5px; -khtml-border-radius: 5px;" >
		...
		<div id="vehicles" style="-webkit-border-radius: 10px; -moz-border-radius: 10px; border-radius: 10px; padding: 20px; height:480px; margin-bottom: 20px;">
            <form id="postVehicle" method="post" action="/UserProfileController">
			<p>
		...
		<div id="general" style="-webkit-border-radius: 10px; -moz-border-radius: 10px; border-radius: 10px; padding: 20px; height:480px; margin-bottom: 20px;">
			<form id="postGeneral" method="post" action="/UserProfileController">
			<p>
