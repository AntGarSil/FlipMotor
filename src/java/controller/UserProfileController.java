...
//            out.println("                                <input id='email' name='email' class='required email' type='text'  style='width:200px'/></div>");
            ...
            while (msg != null)
            {
                ...
                if(msg.getIntProperty("SenderId") != uid) isInbox = true;
                ...
                {
                    out.println("<div> <b>To: </b><a href='Advert?code=" + msg.getIntProperty("VehicleAd") +"&num=" + msg.getIntProperty("num") +"'> Advertisement </a></div> ");
                    out.println("<div>" + msg.getText() +"     </div> ");                                
                }
                ...
                if(isInbox)
                {
                    out.println("<div style='margin-left:40%;'> <input type='button'id='modalReply" + msg.getJMSTimestamp() +"' value='Reply'/></div>");
                }
                out.println("</div>");
